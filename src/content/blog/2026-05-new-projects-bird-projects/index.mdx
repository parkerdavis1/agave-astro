...
import Australia from './australia-raincrow.png'
...
The other fun update is you can view recent [**RainCrow**](/projects/raincrow) useage [on a map](https://timezone.parker.town/map). Right now, it looks like someone is sailing along the coast of Australia and eBirding along the way! So cool. 

<a href="https://timezone.parker.town/map"><Image src={Australia} layout='constrained' width={700} alt="Map showing a series of dots along the coast of Australia" /></a>
