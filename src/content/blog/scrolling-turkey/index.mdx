...
import linksOriginal from './links-original.png'
import scrollingTurkey from './scrolling-turkey.gif'
...
<Image src={linksOriginal} alt="Original links page screenshot" class="small-image" />
...
<Image src={scrollingTurkey} alt="Links page with scrolling turkey" class="small-image" />
