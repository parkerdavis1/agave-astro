...
<div class="w-fit">
    <LikeButton url="quail-post" client:only />
</div>

Here is the SVG at a larger scale. I created this SVG, loading in a photo and tracing geometric shapes on top of it using Pixelmator Pro, then exporting the shapes to SVG.
...
Part of why I can do this more easily is I ported my portfolio to Astro. I can drop a Quail svelte component in, call a dynamic API route that lives within my project structure that interacts with a database, I'm using Astro DB.